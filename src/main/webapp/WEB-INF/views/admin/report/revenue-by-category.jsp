...
<h2 class="alert alert-success">DOANH THU THEO LOẠI</h2>
<div class="row">
	<div class="col-sm-12">
...
<h3 class="alert alert-success"> BIỂU ĐỒ DOANH THU THEO LOẠI HÀNG</h3>
<jsp:include page="_revenue_category_chart.jsp"/>
